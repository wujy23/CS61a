...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def roll_num( player_score, opponent_score):
        return n
...
def make_averaged(original_function, total_samples=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def average_anwser(*args):
        temp = 0
        i = 0
        while i < total_samples:
            temp += original_function(*args)
            i += 1
        return temp / total_samples
    
    return average_anwser
    # END PROBLEM 8
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    temp = square_update(0,score,opponent_score) - score
    if temp >= threshold:
        return 0
...
# def final_strategy(score, opponent_score, goal = GOAL,dice = six_sided,num_rolls = 6):
#     """Write a brief description of your final strategy.
#     当目标接近时，投掷越少的骰子风险越低，可编写“官子”策略，当寻找当前获胜的最小投掷数，若该数量小于某阈值，则可认为在较低风险下取得胜利
#     *** YOUR DESCRIPTION HERE ***
#     """
#     # BEGIN PROBLEM 12
#     i = 0
#     while i <= 3:
#         if make_averaged(roll_dice,1000)(i,dice) >= goal - score:
#             return i
#     return num_rolls  # Remove this line once implemented.
#     # END PROBLEM 12
